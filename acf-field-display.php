...
define( 'LTS_URL', WP_PLUGIN_URL . '/acf-field-display' );
...
function lt_acf_field_display_scripts(){
	wp_register_script('acf-fd-functions-js', LTS_URL . '/js/functions.js');
	wp_enqueue_script('acf-fd-functions-js');
	wp_register_script('tablesorter-js', LTS_URL . '/js/jquery.tablesorter.min.js');
	wp_enqueue_script('tablesorter-js');
	wp_register_style('table-style', LTS_URL . '/css/table.css');
